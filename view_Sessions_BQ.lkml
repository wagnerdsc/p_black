...
#             , events.ecommerce
#             , events.items
#               from `e-commerce-dev1.analytics_216714406.events_intraday_*` events
#               where PARSE_DATE('%Y%m%d',  event_date) = CURRENT_DATE()
#               or PARSE_DATE('%Y%m%d',  event_date) = CURRENT_DATE('America/Sao_Paulo')
