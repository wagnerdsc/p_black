...
view: sessions {
  sql_table_name: @{GA4_VIEW_SESSION} ;;
...
## Dimensions
  ...
  # Sessão definida pelo cliente em conversa no dia 15/11
  # concat(user_pseudo_id,(select value.int_value from unnest(event_params) where key = 'ga_session_id')) as id_sessao
  dimension: sessao_id {
    description: "Id Sessão"
    type: string
    sql:concat(${user_pseudo_id} ,${ga_session_id})  ;;
  }
