...
- dashboard: ga4_features
  ...
  - title: Sessions
    ...
    conditional_formatting: [{type: not null, value: !!null '', background_color: "#FF9700",
    ...
    listen:
      ...
      Session Time: sessions.session_time
    row: 8
    col: 0
    width: 6
    height: 3
  - title: Users
    ...
    conditional_formatting: [{type: not null, value: !!null '', background_color: "#33A069",
        font_color: "#FFF", color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2,
          palette_id: 56d0c358-10a0-4fd6-aa0b-b117bef527ab}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}]
    x_axis_gridlines: false
  ...
  - title: Page Views
    ...
    conditional_formatting: [{type: not null, value: !!null '', background_color: "#C6352F",
  ...
  - title: PRODUTOS MAIS COMPRADOS
    ...
    explore: sessions
    type: looker_bar
    fields: [events.total_item_quantity, event_data_items.item_name]
    sorts: [events.total_item_quantity desc 0]
    limit: 500
    column_limit: 50
    x_axis_gridlines: false
    y_axis_gridlines: true
  ...
  - title: PRODUTOS MAIS VISITADOS
    ...
    explore: sessions
    type: looker_bar
    fields: [event_data_items.item_name, sessions.qtde_sessoes]
  ...
  - name: " (3)"
    ...
    body_text: "<div style=\"border: solid 1px #1A73E8; border-radius: 5px; padding:\
      ...
      \ href=\"/dashboards-next/ga4_realtime::overview\">\n  \t<svg style=\"height:\
      ...
      ></path>\n</svg>\nGA Overview</a>\n<a style=\"padding: 5px; line-height: 40px;\"\
      \ href=\"/dashboards-next/ga4_realtime::audience\">\n<svg style=\"height: 16px;\
      ...
      ></path>\n</svg>\nAudience</a>\n<a style=\"padding: 5px; line-height: 40px;\"\
      \ href=\"/dashboards-next/ga4_realtime::acquisition\">\n<svg style=\"height:\
      \ 16px; fill: #4285F4;\" class=\"svg-icon\" viewBox=\"0 0 20 20\">\n<path d=\"\
      M8.749,9.934c0,0.247-0.202,0.449-0.449,0.449H4.257c-0.247,0-0.449-0.202-0.449-0.449S4.01,9.484,4.257,9.484H8.3C8.547,9.484,8.749,9.687,8.749,9.934\
      ...
      ></path>\n</svg>\nAcquisition</a>\n<a style=\"padding: 5px; line-height: 40px;\"\
      \ href=\"/dashboards-next/ga4_realtime::behavior\">\n<svg  style=\"height: 16px;\
      ...
      ></path>\n</svg>\nBehavior</a>\n<a style=\"padding: 5px; line-height: 40px;\"\
      \ href=\"/dashboards-next/ga4_realtime::custom_goal_conversions\">\n<svg  style=\"\
  ...
  - title: Untitled
    ...
    dynamic_fields:
    - category: measure
      expression: "${events.event_param_engagement_time_msec} > 0 OR ${events.event_param_session_engaged}\
        \ = 1"
      label: Count of User Pseudo ID
      based_on: events.user_pseudo_id
      filter_expression: "${events.event_param_engagement_time_msec} > 0 OR ${events.event_param_session_engaged}\
        \ = 1"
      _kind_hint: measure
      ...
      _type_hint: number
      filters: {}
    - measure: count_of_user_pseudo_id_2
      based_on: events.user_pseudo_id
      expression: ''
      label: Count of User Pseudo ID
      type: count_distinct
  ...
  - title: Page Views (Copy)
    ...
    comparison_label: Unique Page Views
    conditional_formatting: [{type: not null, value: !!null '', background_color: "#0071A3",
        font_color: !!null '', color_application: {collection_id: 7c56cc21-66e4-41c9-81ce-a60e1c3967b2,
          palette_id: 56d0c358-10a0-4fd6-aa0b-b117bef527ab}, bold: false, italic: false,
        strikethrough: false, fields: !!null ''}]
    x_axis_gridlines: false
  ...
  - title: Untitled
    ...
    explore: sessions
    type: looker_funnel
    fields: [sessions.qtde_sessoes, events.event_name]
    sorts: [sessions.qtde_sessoes desc 0]
    limit: 500
    column_limit: 50
